...
class AccountsSectionWidget extends StatefulWidget {
  ...
  AccountsSectionWidget({super.key,
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          if (index < pinnedAccounts.length) {
            ...
            final transactionsOfAcc = widget.transactions.where((tran) => tran.accountId == acc.id).toList();
            return SizedBox(
              width: 180,
              child: HomeAccountCard(account: acc, transactions: transactionsOfAcc,),
            );
          } else {
            return SizedBox(
              width: 180,
                                    ...
                                    onPressed: () {
                                      ...
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                          builder:
                                              (context) =>
                                           EditAccountsPage(accounts: widget.accounts, transactions: widget.transactions,),
                                        ),
                                      );
                                    },
                                  ),
                              ...
                              ListTile(
                                ...
                                onTap: () {
                                  ...
                                  Navigator.of(context).push(
                                    MaterialPageRoute(
                                      builder:
                                          (context) =>  AddAccountPage(account: null,),
                                    ),
                                  );
                                },
                              ),
